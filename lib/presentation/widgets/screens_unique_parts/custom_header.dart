...
//     this.spacing = 6.0, // Default spacing
//   });
//
//   @override
...
//       context: context,
//       removeLeft: true, // ❌ REMOVE LEFT SYSTEM PADDING
//       child: Container(
//         height: 130.h,
...
//               children: [
//
//                 /// BACK BUTTON (NO LEFT PADDING NOW)
//                 CustomCurvedArrow(
//                   isLeft: true,
...
class _CustomHeaderState extends State<CustomHeader> {
  ...
  void _navigateToLanguage() {
    ...
    // ✅ Navigate to language screen with from parameter
    Get.toNamed(
      AppRoutes.language,
      parameters: {
        'from': currentRoute,
