...
class CustomCardPagerBuilder extends StatelessWidget {
  ...
  final bool buildActionButton; // 🔹 NEW: Boolean to control button visibility

  const CustomCardPagerBuilder({
    super.key,
    required this.controller,
    this.buildActionButton = true, // 🔹 Default to true (backward compatible)
  });
        ...
        return OrientationBuilder(
          builder: (context, orientation) {
            return _ResponsiveCardPager(
              ...
              buildActionButton: buildActionButton, // 🔹 Pass the parameter
            );
          },
        );
      },
...
class _ResponsiveCardPager extends StatelessWidget {
  ...
  final bool buildActionButton; // 🔹 NEW: Boolean parameter

  const _ResponsiveCardPager({
    required this.controller,
    required this.constraints,
    required this.orientation,
    required this.buildActionButton, // 🔹 NEW: Required parameter
  });
...
//
// // not confirm but guess may create conflict
//
// import 'package:flutter/material.dart';
// import 'package:flutter_screenutil/flutter_screenutil.dart';
// import 'package:get/get.dart';
...
//                         )
//                       : Image.asset(
//                           controller.cardAssets[controller
//                               .selectedCardIndex
//                               .value],
//                           key: ValueKey<int>(
