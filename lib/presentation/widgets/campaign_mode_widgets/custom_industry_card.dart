...
class CustomIndustryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(
      ...
      children: [
        /// 🔹 Top Row (Avatar + Titles + Circle) - FIXED ALIGNMENT
        Row(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 2.h), // Small gap between title and subtitle
                  Text(
                    subTitle,
                    style: TextStyle(
                      color: Colors.grey,
                    ...
                    maxLines: 50, // Limit to 2 lines
                    overflow: TextOverflow.ellipsis, // Add ellipsis if too long
                  ),
                ],
              ),
            ),
            // 🔹 Right circle with lock - Now properly aligned to top
            Container(
              width: 22.w,
              height: 22.w,
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: isUnlocked ? AppColors.primaryRed : Colors.transparent,
                border: Border.all(
                  color: isUnlocked ? AppColors.primaryRed : AppColors.grey,
                  width: 1.5,
                ),
