...
class KeyResultsController extends GetxController {
  ...
  List<Map<String, dynamic>> getSelectedKeyResults() {
    return selectedIndexes.map((index) => keyResults[index]).toList();
  }
  ...
  final List<Map<String, dynamic>> keyResults = [
    {
      ...
      "description": "Generate significant revenue stream within first 12 months of launch",
    ...
    },
    {
      ...
      "description": "Build customer base in target emerging markets through product adoption",
      "icon": Icons.people,
    ...
    },
    {
      ...
      "description": "Establish significant market presence through new product penetration",
    ...
    },
    {
      ...
      "description": "Maintain high quality standards and customer experience across new products",
      "icon": Icons.star,
      "tag1": "Satisfaction",
      "tag2": "Ongoing",
    },
    {
      ...
      "description": "Optimize development cycles to gain competitive advantage in time-to-market",
      "icon": Icons.speed,
      "tag1": "Medium Impact",
      "tag2": "9 months",
    },
  ...
  List<String> getSelectedTitles() {
    return selectedIndexes.map((index) => keyResults[index]["title"] as String).toList();
  }
}
