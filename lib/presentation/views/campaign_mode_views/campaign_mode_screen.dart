...
//             // Debug verification
//             final savedMode = await SharedPrefs.getGameMode();
//             final campaignStatus = await CampaignProgressService
//                 .getCampaignStatus();
//
//             print('🎮 Campaign Mode: $savedMode');
...
//                               future: CampaignProgressService
//                                   .getCampaignStatus(),
...
//                                       onStart: () =>
//                                           _startOrganization(1, controller),
//                                     ),
//
//                                     // Organization B (Level 2)
//                                     _buildOrganizationCard(
...
//
//
//   // In CampaignModeScreen - replace _startOrganization method
