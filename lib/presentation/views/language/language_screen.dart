...
class LanguageScreen extends StatelessWidget {
  ...
  // }
  Widget _buildContinueButton(double screenWidth, bool isTablet) {
    final from = Get.parameters['from']; // kis screen se aaye
      ...
      child: CustomButton(
        ...
        onPressed: () {
          if (from != null && from.isNotEmpty) {
            // ✅ Sirf back jao (settings ya previous screen)
            Get.back();
          } else {
            // ✅ First time flow
...
//   late String? _fromRoute;
//
//   @override
//   void initState() {
//     super.initState();
//     _fromRoute = Get.parameters['from'];
//     developer.log(
//       '🌐 LanguageScreen opened from: $_fromRoute',
//       name: 'LanguageScreen',
//     );
//   }
//
...
//     developer.log(
//       '👉 Continue button pressed - from: $_fromRoute',
//       name: 'LanguageScreen',
//     );
//
//     // ✅ Add small delay to ensure language change is processed
//     Future.delayed(const Duration(milliseconds: 300), () {
//       if (_fromRoute != null && _fromRoute!.isNotEmpty && _fromRoute != AppRoutes.language) {
//         developer.log(
//           '✅ Navigating back to: $_fromRoute',
//           name: 'LanguageScreen',
//         );
//         Get.offAllNamed(_fromRoute!);
//       } else {
//         developer.log(
//           '➡️ No from route, navigating to register',
//           name: 'LanguageScreen',
//         );
...
//             onTap: () {
//               developer.log(
//                 '🔤 Language selected: ${supportedLang.name}',
//                 name: 'LanguageScreen',
//               );
//               controller.changeLanguage(supportedLang);
//             },
//           ),
//         );
//       });
