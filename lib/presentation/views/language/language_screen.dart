...
class LanguageScreen extends StatelessWidget {
    ...
    return Scaffold(
      body: OrientationBuilder(
        builder: (context, orientation) {
          ...
          final maxContentWidth = isDesktop ? 600.0 : (isTablet ? screenWidth * 0.8 : double.infinity);

          // Responsive typography
          final titleStyle = (theme.textTheme.headlineLarge ?? const TextStyle(fontSize: 22))
              .copyWith(
            fontSize: _getResponsiveTitleSize(screenWidth, isLandscape),
            fontWeight: FontWeight.w600,
          );

          final tileTitleStyle = (theme.textTheme.bodyLarge ?? const TextStyle(fontSize: 16))
              .copyWith(fontSize: _getResponsiveTileSize(screenWidth));

          final tileSubtitleStyle = (theme.textTheme.bodyMedium ?? const TextStyle(fontSize: 14))
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: _getResponsiveSpacing(screenHeight, 0.035)),
    ...
    return Row(
      ...
      children: [
        Image.asset(
          ...
          height: _getResponsiveImageHeight(screenHeight, screenWidth, isLandscape),
          fit: BoxFit.contain,
        ),
  ...
  double _getResponsiveImageHeight(double screenHeight, double screenWidth, bool isLandscape) {
    if (isLandscape) {
