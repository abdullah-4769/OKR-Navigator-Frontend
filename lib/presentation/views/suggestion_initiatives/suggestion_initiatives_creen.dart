...
class SuggestionInitiativesScreen extends StatelessWidget {
  ...
  SuggestionInitiativesScreen({super.key,
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Obx(
                              () => CustomButton2(
                            text: viewModel.isSubmitting.value ? 'submitting'.tr : 'submit_analysis'.tr,
...
// //   }
// // }
// // lib/presentation/screens/suggestion_initiatives/suggestion_initiatives_screen.dart
//
// // lib/presentation/screens/suggestion_initiatives/suggestion_initiatives_screen.dart
// // lib/presentation/screens/suggestion_initiatives/suggestion_initiatives_screen.dart
//
...
//                         highlightedText: 'of_initiatives'.tr,
//                         subtitle: 'add_initiatives_subtitle'.tr,
//                         onBackTap: () => Get.offAllNamed(AppRoutes.keyResultsScreen),
//                       ),
//                       SizedBox(height: screenHeight * 0.01),
//                       CustomInitiativeInput(
//                         numberText: 'first_initiative'.tr,
