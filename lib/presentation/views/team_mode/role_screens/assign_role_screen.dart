...
class AssignRolesScreen extends StatelessWidget {
 ...
 Widget build(BuildContext context) {
  ...
  return Scaffold(
   // FIXED: Remove transparent background
 ...
 Widget _buildMemberCard(BuildContext context, String name, String level, dynamic member, AssignRolesController controller) {
  ...
  return Container(
   ...
   decoration: BoxDecoration(
    ...
    // FIXED: Add shadow for better visual appearance like CreateTeamScreen
    boxShadow: [
     BoxShadow(
    ...
    children: [
     ...
     Obx(() => DropdownButtonFormField<String>(
      ...
      decoration: InputDecoration(
       ...
       filled: isDisabled,
       fillColor: isDisabled ? AppColors.grey.withOpacity(0.1) : AppColors.softRed.withOpacity(0.1),
