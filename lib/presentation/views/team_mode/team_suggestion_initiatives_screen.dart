...
class TeamSuggestionInitiativesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ CHANGED: Get one random key result instead of the first one
    final randomKeyResult = controller.getRandomKeyResult();
    final randomKRTitle = _safeTranslate(randomKeyResult.title, fallback: 'Focus on Key Result');
    final randomKRDescription = _safeTranslate(randomKeyResult.description, fallback: 'Detail not available');
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      /// ✅ Your Objective Container - Now showing random key result
                      Padding(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      // ✅ CHANGED: Using random key result title
                                      randomKRTitle,
                                    ...
                                    SizedBox(height: 4.h),
                                    Text(
                                      // ✅ CHANGED: Using random key result description
                                      randomKRDescription,
                      ...
                      /// ✅ REMOVED: Key Results List section completely removed
