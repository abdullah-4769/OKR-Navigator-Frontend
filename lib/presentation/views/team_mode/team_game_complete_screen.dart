         ...
         child: SingleChildScrollView(
          ...
          child: Column(
           ...
           Obx(() => CustomScoreCard(
            ...
            title: controller.titles.isNotEmpty ? controller.titles.first : "strategic_master".tr,
                ...
                return Padding(
                    ...
                    child: Column(
                        children: controller.memberData.map((member) => TeamMemberCard(
                            ...
                            onViewTap: member['status'].toString().toLowerCase() == "view" 
                                ? () => controller.viewMemberScore(member['userId'].toString())
                                : null,
                        )).toList(),
                    ),
                );
