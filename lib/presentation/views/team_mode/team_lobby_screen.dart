   ...
   children: [
    ...
    child: SingleChildScrollView(
     ...
     children: [
      ...
      /// Start Game text
      Text(
      "Start Game, Only one member allowed to start the game",
      style: TextStyle(
       color: AppColors.primaryRed,
       fontSize: 13.sp,
      ...
      child: Column(
       children: [
       // Begin Mission Button (Only Host can start the game) - Testing: 1 player allowed
       CustomButton2(
        backgroundColor: (isHost && membersCount >= 1) ? AppColors.primaryBlue : AppColors.textSecondary.withOpacity(0.3),
        textColor: Colors.white,
        text: "Begin Mission".tr,
        onPressed: (isHost && membersCount >= 1) ? controller.beginMission : null,
       ),
             ...
             children: [
              ...
              onPressed: () async {
               ...
               try {
                await Share.share(
                 shareableLink,
                 subject: 'Join my team on OKR Navigator!',
                );
               } catch (e) {
                SnackbarHelper.error('Failed to share link');
               }
              },
