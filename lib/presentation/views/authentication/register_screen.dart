...
class RegisterScreen extends StatelessWidget {
  ...
  Widget _buildTitleSection(ThemeData theme, double screenWidth, bool isPortrait, bool isTablet) {
  ...
  Widget _buildSubtitleSection(double screenWidth, bool isTablet, bool isDesktop) {
  ...
  Widget _buildSignInPrompt(ThemeData theme, double screenWidth, bool isPortrait, bool isTablet) {
    final promptTextSize = _getPromptTextSize(screenWidth, isPortrait, isTablet);
  ...
  double _getPromptTextSize(double screenWidth, bool isPortrait, bool isTablet) {
