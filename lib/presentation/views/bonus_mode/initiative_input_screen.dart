...
class _InitiativeInputScreenState extends State<InitiativeInputScreen> {
  ...
  void initState() {
    super.initState();
    // ✅ DO NOT START A NEW TIMER - Timer is already running from CasePresentationScreen
    print('⏱️ InitiativeInputScreen - Timer already running: ${controller.getFormattedTime()}');
  }

  @override
  void dispose() {
    // ✅ DO NOT STOP THE TIMER - It will be stopped after evaluation
    super.dispose();
  }
                      ...
                      children: [
                        ...
                        CustomButton2(
                          ...
                          onPressed: () async {
                            ...
                            controller.setInitiative(initiativeCtrl.text);
                            // ✅ DO NOT STOP TIMER HERE - Let evaluation screen handle it
