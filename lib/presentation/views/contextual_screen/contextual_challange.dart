...
//                                 child: CustomMarketDisruptionCard(
//                                   icon: Icons.warning_amber_rounded,
//                                   title: challengeViewModel
//                                       .marketDisruptionTitle,
//                                   description: challengeViewModel
//                                       .marketDisruptionDescription,
//                                   warningText: 'revenue_drop_warning'.tr,
//                                   warningIcon: Icons.trending_down,
//                                 )
//                             );
...
//                                     actionColor: AppColors.primaryBlue,
//                                     onActionTap: () {
//                                       // Use a fixed strategy ID or get it from another source
//                                       final strategyId = 4; // or from your business logic
//                                       _showInnovativeStrategiesDialog(
...
//
//   /// 🔹 Initiative Item
//   Widget _buildInitiativeItem(BuildContext context,
//       int number,
//       String title,
//       String subtitle,) =>
//       Container(
...
//                       SizedBox(height: 8.h),
//                       Text(
//                         innovativeViewModel.errorMessage.value,
//                         textAlign: TextAlign.center,
//                         style: Theme
//                             .of(context)
//                             .textTheme
...
//                       ElevatedButton.icon(
//                         onPressed: () =>
//                             innovativeViewModel.fetchInnovativeStrategies(
//                                 strategyId),
//                         icon: Icon(Icons.refresh, size: 18),
//                         label: Text('Try Again'),
//                         style: ElevatedButton.styleFrom(
...
//                       SizedBox(height: 8.h),
//                       Text(
//                         'No innovative strategies available for this selection.',
//                         textAlign: TextAlign.center,
//                         style: Theme
//                             .of(context)
//                             .textTheme
...
//                           Expanded(
//                             child: Text(
//                               'Found ${innovativeViewModel.innovativeStrategies
//                                   .length} strategy(s)',
//                               style: Theme
//                                   .of(context)
//                                   .textTheme
...
//                         shrinkWrap: true,
//                         physics: const BouncingScrollPhysics(),
//                         itemCount: innovativeViewModel.innovativeStrategies
//                             .length,
//                         itemBuilder: (context, index) {
//                           final strategy = innovativeViewModel
//                               .innovativeStrategies[index];
...
//   }
//
//   Widget _buildInnovativeItem(BuildContext context, String number,
//       InnovativeItem item) {
//     return Container(
//       margin: EdgeInsets.only(bottom: 8.h),
//       padding: EdgeInsets.all(12.w),
