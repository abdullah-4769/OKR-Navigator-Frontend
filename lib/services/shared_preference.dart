...
//   }
//
// // Call this when starting a new game or when retrying
//   static Future<void> clearForRetry() async {
//     print('🔄 Clearing data for retry...');
//
//     // Clear only the data that needs to be regenerated
...
//     print('💾 Saved ${keyResults.length} Key Results');
//   }
// // In your SharedPrefs class - FIXED VERSION
// //   static Future<void> saveCertificateKeyResults(List<Map<String, String>> keyResults) async {
// //     try {
// //       print('💾 Starting to save certificate key results...');
// //
// //       // ✅ SAFE: Convert to ensure no null values
// //       final List<Map<String, String>> safeKeyResults = keyResults.map((result) {
// //         return {
// //           'title': result['title'] ?? 'Untitled Key Result', // Use ?? instead of !
// //           'description': result['description'] ?? 'No description provided',
// //         };
// //       }).toList();
// //
// //       print('🔍 Prepared key results for saving: $safeKeyResults');
// //
// //       final jsonString = jsonEncode(safeKeyResults);
// //
// //       if (_prefs == null) {
...
// //
// //       await _prefs!.setString('certificateEnteredKeyResults', jsonString);
// //       print('✅ Successfully saved ${safeKeyResults.length} key results to SharedPreferences');
// //
// //     } catch (e) {
// //       print('❌ Error in saveCertificateKeyResults: $e');
